          ...
          <main className="flex-1 overflow-y-auto p-4 md:p-8">
            {!aq ? (
              ...
              <div className="max-w-2xl mx-auto">
                ...
                {/* Question text */}
                <h2 className="text-[19px] font-semibold text-slate-900 mb-6 leading-relaxed whitespace-pre-line">
                  ...
                  {opts.map(opt => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-[15px] text-slate-800 font-medium flex-1 leading-snug">{opt.option_text}</span>
                      </button>
                    );
                  })}
                </div>
