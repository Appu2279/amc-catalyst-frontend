/**
 * Option lists for the registration form.
 *
 * These are the source of truth for what the API accepts. The frontend keeps an
 * identical copy at amc-catalyst-frontend/src/constants/registration.js so the
 * form can render without an extra round trip — update both together.
 */

export const PROFESSIONAL_ROLES = [
  { value: 'medical_student',      label: 'Medical Student' },
  { value: 'intern',               label: 'Intern' },
  { value: 'resident',             label: 'Resident / RMO' },
...
export const professionalRoleLabel = (value) =>
  PROFESSIONAL_ROLES.find((r) => r.value === value)?.label ?? null;

// Graduation year may be in the future — students and interns register with the
// year they expect to graduate.
export const GRADUATION_YEAR_MIN = 1950;
export const graduationYearMax = () => new Date().getFullYear() + 10;

// ISO 3166-1 alpha-2. The code is what gets stored; the name is for display and
// for anything that exports pre-registration data.
